...
export default function AboutPage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FDF8F3" }}>
      ...
      <header className="relative py-24 px-4 text-white text-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 50%, #F9AE27 0%, transparent 50%), radial-gradient(circle at 80% 20%, #CA8406 0%, transparent 40%)",
            }}
          />
        </div>
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            ...
            <br />
            <span style={{ color: "#F9AE27" }}>Since 2003</span>
          </motion.h1>
          <motion.p
            className="text-xl md:text-2xl text-[#FBD78B] max-w-2xl mx-auto"
      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 text-center">
          {achievements.map((item, i) => (
            ...
            >
              <p className="text-3xl font-bold" style={{ color: "#F9AE27" }}>
                {item.number}
              </p>
              <p className="text-sm text-[#F9AE27] mt-1">{item.label}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-4">
        ...
        <section className="py-20" aria-label="Our founder story">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              <h2 className="text-4xl font-bold mb-6" style={{ color: "#32173F" }}>
            ...
            >
              ...
              >
                ...
                <p style={{ color: "#F9AE27" }}>Founder &amp; Lead Instructor</p>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-5 gap-4">
            {methodology.map((step, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-lg mb-2" style={{ color: "#32173F" }}>
                  {step.title}
                </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {differentiators.map((item, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-xl mb-3" style={{ color: "#32173F" }}>
                  {item.title}
                </h3>
        ...
        <section className="py-20" aria-label="About our instructor">
          <motion.div
            ...
            style={{
              background: "linear-gradient(135deg, #32173F 0%, #5A2A72 100%)",
            }}
            {...fadeInUp}
          >
            <div className="grid lg:grid-cols-2">
              <div className="p-10 md:p-14 text-white">
                ...
                <p className="text-xl mb-8" style={{ color: "#CA8406" }}>
                  Founder &amp; Lead Instructor
                </p>
                <p className="text-[#FBD78B] leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-3 text-[#FBD78B]">
                      <div
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: "#32173F" }} className="py-10 px-4" aria-label="Footer">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-6 pt-6 border-t border-[#CA8406] text-center text-[#F9AE27] text-sm">
