...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8E7]">
      {/* Navigation */}
      <nav className="bg-[#5A2A72] py-4 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center">
            <span className="inline-block rounded-lg bg-white px-3 py-2">
              <Image src="/images/logo-owl.png" alt="Speedy Scholars Logo" width={2048} height={1002} className="h-10 w-auto" />
            </span>
          </Link>
      ...
      {/* Hero Header */}
      <header className="bg-gradient-to-br from-[#5A2A72] to-[#3F1D50] py-16 px-4 md:px-8 lg:px-16 text-white text-center">
      ...
      <main className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-[#5A2A72] mb-8">Contact Information</h2>

              <div className="space-y-6">
                {/* Phone */}
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#F9AE27] to-[#CA8406] rounded-full flex items-center justify-center flex-shrink-0">
                    <Phone className="w-7 h-7 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-[#5A2A72] text-lg mb-1">Call Us</h3>
                    <a href="tel:+919352646671" className="text-gray-700 hover:text-[#5A2A72] transition text-lg">
                      +91 9352646671
                    </a>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-[#5A2A72] text-lg mb-1">WhatsApp</h3>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition">
                  ...
                  <div>
                    <h3 className="font-bold text-[#5A2A72] text-lg mb-1">Email Us</h3>
                    <a href="mailto:nidhikhariwal2012@gmail.com" className="text-gray-700 hover:text-[#5A2A72] transition text-lg">
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition">
                  ...
                  <div>
                    <h3 className="font-bold text-[#5A2A72] text-lg mb-1">Location</h3>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition">
                  ...
                  <div>
                    <h3 className="font-bold text-[#5A2A72] text-lg mb-1">Class Timings</h3>
            ...
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold text-[#5A2A72] mb-8">Send Us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-xl">
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-2xl font-bold text-[#5A2A72] mb-2">Message Sent!</h3>
                  ...
                  <>
                    <div className="space-y-6">
                      {/* Name */}
                      <div>
                        <label htmlFor="name" className="block text-sm font-semibold text-[#5A2A72] mb-2">
                          Your Name *
                        </label>
                        <input
                          type="text"
                          ...
                          required
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#5A2A72] focus:outline-none transition"
                      ...
                      {/* Email */}
                      <div>
                        <label htmlFor="email" className="block text-sm font-semibold text-[#5A2A72] mb-2">
                          Email Address *
                        </label>
                        <input
                          type="email"
                      ...
                      {/* Phone */}
                      <div>
                        <label htmlFor="phone" className="block text-sm font-semibold text-[#5A2A72] mb-2">
                          Phone Number
                        </label>
                        <input
                          type="tel"
                      ...
                      {/* Child's Age */}
                      <div>
                        <label htmlFor="childAge" className="block text-sm font-semibold text-[#5A2A72] mb-2">
                          Child&apos;s Age *
                        </label>
                        <select
                          id="childAge"
                          ...
                          onChange={handleChange}
                          required
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#5A2A72] focus:outline-none transition bg-white"
                        >
                      ...
                      {/* Message */}
                      <div>
                        <label htmlFor="message" className="block text-sm font-semibold text-[#5A2A72] mb-2">
                          Your Message
                        </label>
                        <textarea
                          id="message"
                          ...
                          onChange={handleChange}
                          rows={4}
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#5A2A72] focus:outline-none transition resize-none"
                    ...
                    <button
                      ...
                      className="w-full mt-8 bg-gradient-to-r from-[#5A2A72] to-[#3F1D50] text-white py-4 rounded-xl font-semibold hover:shadow-xl transition transform hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
          ...
          <section className="mt-20">
            <h2 className="text-3xl font-bold text-[#5A2A72] mb-8 text-center">Frequently Asked Questions</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="bg-white p-6 rounded-2xl shadow-lg">
                  <h3 className="font-bold text-[#5A2A72] mb-2">{faq.q}</h3>
      ...
      {/* Footer */}
      <footer className="bg-[#5A2A72] text-white py-8 px-4 md:px-8 lg:px-16 text-center">
